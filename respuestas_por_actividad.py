...
FLUJOS_POR_ACTIVIDAD = {
    "bananera": {
        "introduccion": "🍌 ¡Hola! En *DALGORO - Innovación y Sostenibilidad* trabajamos con fincas bananeras para facilitar el cumplimiento ambiental y evitar sanciones. ¿Podría indicarnos si ya cuenta con un permiso ambiental como registro o licencia?\n\n👉 Ya tengo permiso\n👉 Aún no tengo ninguno",
    ...
    "camaronera": {
        "introduccion": "🦐 ¡Gracias por escribirnos! Trabajamos con productores camaroneros para ayudarlos a cumplir con la normativa ambiental. ¿Actualmente cuenta con registro o licencia ambiental?\n\n👉 Ya tengo\n👉 No tengo ninguno",
    ...
    "cacaotera": {
        "introduccion": "🍫 ¡Hola! En *DALGORO - Innovación y Sostenibilidad* asesoramos a productores cacaoteros como usted para que cumplan con la normativa ambiental sin complicaciones. ¿Nos puede confirmar si ya cuenta con permiso ambiental (registro o licencia)?\n\n👉 Ya tengo permiso\n👉 No tengo aún",
    ...
    "ciclo_corto": {
        "introduccion": "🌽 ¡Saludos! Si trabaja con cultivos de ciclo corto como maíz, arroz o hortalizas, es posible que requiera permisos ambientales. ¿Ya tiene algún permiso ambiental vigente?\n\n👉 Sí, ya tengo\n👉 No tengo aún",
    ...
    "granja_avicola": {
        "introduccion": "🐔 ¡Hola! En *DALGORO - Innovación y Sostenibilidad* ayudamos a granjas avícolas a cumplir con los permisos ambientales necesarios para operar sin sanciones. ¿Su granja ya tiene registro o licencia ambiental?\n\n👉 Sí, ya tiene\n👉 No tiene aún",
    ...
    "granja_porcina": {
        "introduccion": "🐷 ¡Hola! En *DALGORO - Innovación y Sostenibilidad*, nos especializamos en ayudar a granjas porcinas a cumplir con los requisitos ambientales exigidos por la autoridad. ¿Su granja ya cuenta con permiso ambiental?\n\n👉 Sí\n👉 No",
 ...
 "hotel": {
        "introduccion": "🏨 ¡Gracias por su mensaje! Nosotros tenemos experiencia en asesorar a hoteles para que cumplan con los requisitos ambientales sin contratiempos. ¿Podría indicarnos si su hotel ya cuenta con permiso ambiental (registro o licencia)?\n\n👉 Sí, ya tiene\n👉 No tiene aún",
    ...
    "industria": {
        "introduccion": "🏭 ¡Hola! En *DALGORO - Innovación y Sostenibilidad* apoyamos a empresas industriales a cumplir con todas sus obligaciones ambientales. ¿Actualmente su industria tiene registro o licencia ambiental?\n\n👉 Sí, ya tiene\n👉 No tiene aún",
    ...
    "otros": {
        "introduccion": "🌿 ¡Hola! Gracias por escribirnos. Para poder orientarle mejor, nos gustaría conocer más sobre su actividad productiva. Podemos visitarle personalmente para entender su situación y brindarle una solución completa. ¿Le gustaría agendar una evaluación gratuita?\n\n👉 Sí, deseo agendar\n👉 No por ahora",
